...
export enum ActivityLogEventTypeEnum {
  ADHOC_DIRECTIVE_CANCELLED = 'ADHOC_DIRECTIVE_CANCELLED',
  ADHOC_DIRECTIVE_CREATED = 'ADHOC_DIRECTIVE_CREATED',
  ADHOC_PRE_APPROVAL_RETURNED = 'ADHOC_PRE_APPROVAL_RETURNED',
