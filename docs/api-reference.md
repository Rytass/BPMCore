...
Last verified against (2026-08-18, published `v0.10.0`): `libs/shared@0.10.0`, `libs/bpm-core-client@0.10.0`, `libs/bpm-core@0.10.0` (`@rytass/bpm-core-nestjs-module`), `libs/bpm-core-react@0.10.0`. All four packages are one fixed version set, so these numbers move together.
