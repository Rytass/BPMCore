...
describe('client API endpoint resolution', () => {
  ...
  it('derives API auth URL from same-origin GraphQL URL', (): void => {
    expect(resolveApiBaseUrlFromGraphQlEndpoint('/graphql')).toBe('');
  });
