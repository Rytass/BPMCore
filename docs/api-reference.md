...
Last verified against (2026-08-19, published `v0.11.0`): `libs/shared@0.11.0`, `libs/bpm-core-client@0.11.0`, `libs/bpm-core@0.11.0` (`@rytass/bpm-core-nestjs-module`), `libs/bpm-core-react@0.11.0`. All four packages are one fixed version set, so these numbers move together.
